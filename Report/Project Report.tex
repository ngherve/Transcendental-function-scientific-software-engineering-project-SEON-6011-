...
\par In order to build the function we consider various edge and special cases that are important in the evaluation of the function. Part of the function constitute a power function as described in algorithm \ref{alg:pow}. The algorithm was designed to be simple and to achieve optimal performance. It constitutes a foundation for function.
\begin{algorithm}[H]
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{Figures/gui}
